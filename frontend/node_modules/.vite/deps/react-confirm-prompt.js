...
// node_modules/react-confirm-prompt/dist/index.js
var import_react49 = __toESM(require_react());

// node_modules/react-confirm-prompt/dist/component/ConfirmBox.js
var import_react48 = __toESM(require_react());
import "C:/Users/tarig/Downloads/connectus-main/connectus-main/frontend/node_modules/react-confirm-prompt/dist/component/ConfirmBox.css";
...
var AcceleratedAnimation = class extends BaseAnimation {
  ...
  initPlayback(keyframes2, finalKeyframe) {
    ...
    const animation2 = animateStyle(motionValue2.owner.current, name, keyframes2, { ...this.options, duration, times, ease: ease2 });
...
var AnimatePresence = ({ children, exitBeforeEnter, custom, initial = true, onExitComplete, presenceAffectsLayout = true, mode = "sync" }) => {
  ...
  return (0, import_jsx_runtime5.jsx)(import_jsx_runtime5.Fragment, { children: renderedChildren.map((child) => {
    ...
    return (0, import_jsx_runtime5.jsx)(PresenceChild, { isPresent, initial: !isInitialRender.current || initial ? void 0 : false, custom: isPresent ? void 0 : custom, presenceAffectsLayout, mode, onExitComplete: isPresent ? void 0 : onExit, children: child }, key);
  }) });
};
...
// node_modules/react-confirm-prompt/dist/component/helper.js
...
function ConfirmBox(props) {
  ...
  const [iconColor, setIconColor] = (0, import_react48.useState)(getInitialColor(options.type ? options.type : ""));
  const getInitialIcon = (type) => {
    if (options.icon) {
      ...
      switch (type) {
        case "question":
          return import_react48.default.createElement(GrCircleQuestion, null);
        case "warning":
          return import_react48.default.createElement(TiWarningOutline, null);
        case "success":
          return import_react48.default.createElement(GrStatusGood, null);
        default:
          return import_react48.default.createElement(TiInfoOutline, null);
      }
    }
  };
  const [icon, setIcon] = (0, import_react48.useState)(getInitialIcon(options.type ? options.type : ""));
  const handleMouseOver = (e) => {
    e.target.style.backgroundColor = options.hoverColor ? options.hoverColor : "rgb(28 25 23)";
    e.target.style.color = options.hoverTextColor ? options.hoverTextColor : "white";
  };
  const handleConfirmOut = (e) => {
    e.target.style.backgroundColor = options.confirmColor ? options.confirmColor : iconColor;
    e.target.style.color = options.confirmTextColor ? options.confirmTextColor : "white";
  };
  const handleCancelOut = (e) => {
    e.target.style.backgroundColor = options.cancelColor ? options.cancelColor : "rgb(229 231 235)";
    e.target.style.color = options.cancelTextColor ? options.cancelTextColor : "black";
  };
  const confirmRef = (0, import_react48.useRef)(null);
  const cancelRef = (0, import_react48.useRef)(null);
  ...
  const [clicked, setClicked] = (0, import_react48.useState)(true);
  function result(e) {
    setClicked(false);
    setTimeout(() => {
      confirm(e);
  ...
  return import_react48.default.createElement(
    ...
    null,
    import_react48.default.createElement("div", { onClick: () => {
      if (!options.disableBlur)
        result(false);
    }, className: "backGround", style: {
      backgroundColor: options.hideBackground ? "none" : "rgba(0, 0, 0, 0.5)"
    } }),
    import_react48.default.createElement(
      ...
      import_react48.default.createElement(
        motion.div,
        { variants: anime, initial: "hidden", animate: clicked ? "visible" : "hidden", className: "box", style: {
          filter: options.hideShadow ? "none" : "drop-shadow(0 25px 25px rgb(0 0 0 / 0.15))"
        } },
        import_react48.default.createElement(
          "div",
          { className: "boxContainer" },
          import_react48.default.createElement("div", { className: "icon", style: {
            backgroundColor: options.iconColor ? options.iconColor : iconColor
          } }, icon),
          import_react48.default.createElement("div", { className: "title" }, title),
          import_react48.default.createElement("div", { className: "description" }, options.description ? options.description : ""),
          import_react48.default.createElement("button", { onClick: () => result(true), className: "btn action", style: {
            backgroundColor: options.confirmColor ? options.confirmColor : iconColor,
            color: options.confirmTextColor ? options.confirmTextColor : "white"
          ...
          !options.hideCancel && import_react48.default.createElement("button", { onClick: () => result(false), className: "btn cancel", style: {
            backgroundColor: options.cancelColor ? options.cancelColor : "rgb(229 231 235)",
            color: options.cancelTextColor ? options.cancelTextColor : "black"
...
var ConfirmBox_default = ConfirmBox;

// node_modules/react-confirm-prompt/dist/index.js
var import_client = __toESM(require_client());
function showConfirm(title, options = {}) {
  ...
  return new Promise((resolve, reject) => {
    if (root) {
      ...
      const container = (0, import_client.createRoot)(div);
      container.render(import_react49.default.createElement(ConfirmBox_default, { confirm: (answer) => {
        container.unmount();
...
//# sourceMappingURL=react-confirm-prompt.js.map
